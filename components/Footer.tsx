      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12 text-center md:text-left">
        ...
        <div className="flex flex-col items-center md:items-start md:col-span-2">
          ...
          <p className="text-sm font-light text-[#FBF9F5]/60 leading-relaxed max-w-sm mb-4">
            Original contemporary artworks and premium museum-quality prints by Kavita Brijesh Rajput.
          </p>
          <div className="text-[11px] font-light text-[#FBF9F5]/50 tracking-wide">
            {/* Updated location based on her bio */}
            <p>Based in Vadodara, Gujarat, India.</p>
        ...
        <div className="flex flex-col items-center md:items-start">
          ...
          {/* Drop her actual profile URLs into the href attributes below */}
          <a href="https://instagram.com/" target="_blank" rel="noopener noreferrer" className="text-sm font-light text-[#FBF9F5]/80 hover:text-[#C5A059] mb-3 transition-colors duration-300">
            Instagram
          </a>
          <a href="https://facebook.com/" target="_blank" rel="noopener noreferrer" className="text-sm font-light text-[#FBF9F5]/80 hover:text-[#C5A059] mb-3 transition-colors duration-300">
            Facebook
          </a>
          <a href="https://pinterest.com/" target="_blank" rel="noopener noreferrer" className="text-sm font-light text-[#FBF9F5]/80 hover:text-[#C5A059] mb-8 transition-colors duration-300">
            Pinterest
          </a>
      ...
      <div className="max-w-7xl mx-auto px-6 mt-16 pt-8 border-t border-[#FBF9F5]/10 flex flex-col md:flex-row justify-between items-center gap-4 text-center">
        ...
        <div className="flex gap-6 items-center">
          ...
          <span className="text-[10px] uppercase tracking-[0.15em] text-[#FBF9F5]/40 border-l border-[#FBF9F5]/20 pl-6">
            Artworks by Kavita Brijesh Rajput
          </span>
        </div>
      </div>
    </footer>
